...
/**
 * Servlet implementation class CreateNewPictureResponse
 */
@WebServlet("/CreateNewPictureResponse")
public class CreateNewPictureResponse extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateNewPictureResponse() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("EditPictureResponse.jsp?id="+id);
	}
